        ...
        <div class="container-fluid">
          <div class="row">
              ...
              ?>
                  <div class="col-md-7">
                    <ul class="list-group">
                      <li class="list-group-item list-group-item-dark rounded-0" style="text-align:center;">Group Details</li>
                      <li class="list-group-item list-group-item-light rounded-0">
                        <div class="row">
                          <div class="col-md-3 d-flex flex-column justify-content-center align-items-center">
                            <img src="../images/sources/blank-user-icon.png" class="rounded-circle" width="100px" height="100px">
                            <div class="dropdown-divider"></div>
                            <button type="button" id="change-group-picture-button" class="btn btn-info">Change Picture</button>
                          </div>
                          <div class="col-md-9">
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text width100">Group Name</span>
                              </div>
                              <input type="text" class="form-control" id="group-name" value="<?php echo $dataForum['forumName'];?>" required>
                            </div>
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text width100">Description</span>
                              </div>
                              <input type="text" class="form-control" id="group-description" value="<?php echo $dataForum['forumDescription']; ?>" required>
                            </div>
                            <ul class="list-group" style="padding-top:8px;">
                              <li class="list-group d-flex justify-content-center">
                                <button type="button" id="update-group-button" class="btn btn-info">Update Group Profile</button>
                              </li>
                            </ul>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                            <h5 style="text-align:center;padding-top:5px;">Group Participant</h5>
                            <script>var forumid = <?php echo $forumID;?>;</script>
                            <ul class="list-group" id="joined-participant-list"></ul>
                          </div>
                        </div>
                      </li>
                    </ul>
